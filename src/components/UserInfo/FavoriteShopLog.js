...
const FavoriteShopLog = () => {
    ...
    // お店情報20件分を取得するためのURL
    const shopsUrl = `http://webservice.recruit.co.jp/hotpepper/gourmet/v1/?key=${process.env.REACT_APP_HOTPEPPER_API_KEY1}&id=${idNames}&count=20&order=2&format=jsonp`
